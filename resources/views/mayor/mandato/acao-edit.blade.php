    ...
    <div class="acao-wrap">
        ...
        <div class="acao-header">
            <div>
                ...
                <p style="font-size:.82rem;color:var(--ink-muted);margin:.2rem 0 0">Edite os dados da ação e os vínculos com
                    compromisso(s)</p>
            </div>
                ...
                <div class="form-card-body">
                    ...
                    <div class="form-grid-2">
                            ...
                            <select name="mandate_axis_id" id="axisSelect" required onchange="filterPromises(this.value)">
                                ...
                                @foreach ($axes as $axis)
                                    <option value="{{ $axis->id }}"
                                        {{ old('mandate_axis_id', $action->mandate_axis_id) == $axis->id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <input type="text" name="secretaria" value="{{ old('secretaria', $action->secretaria) }}"
                    ...
                    <div class="form-grid-2">
                        ...
                        <div>
                            ...
                            <input type="number" name="physical_progress"
                                value="{{ old('physical_progress', $action->physical_progress) }}" min="0"
                    ...
                    <div class="form-grid-2">
                        <div>
                            ...
                            <input type="date" name="start_date"
                                value="{{ old('start_date', $action->start_date?->format('Y-m-d')) }}">
                        </div>
                        <div>
                            <label>Data de conclusão</label>
                            <input type="date" name="end_date"
                                value="{{ old('end_date', $action->end_date?->format('Y-m-d')) }}">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="form-card-body">
                    <div class="form-grid-3">
                        <div>
                            ...
                            <input type="number" name="investment" value="{{ old('investment', $action->investment) }}"
                                step="0.01" min="0" placeholder="0,00">
                        </div>
                        <div>
                            <label>Fonte de recurso</label>
                            <input type="text" name="funding_source"
                                value="{{ old('funding_source', $action->funding_source) }}"
                                placeholder="ex: Federal, Municipal, PAC">
                        </div>
                        <div>
                            <label>Beneficiários estimados</label>
                            <input type="number" name="beneficiaries"
                                value="{{ old('beneficiaries', $action->beneficiaries) }}" min="0"
                                placeholder="ex: 5000">
                        </div>
                    </div>
                    <div>
                        <label>Região / Bairro</label>
                        <input type="text" name="region" value="{{ old('region', $action->region) }}"
            ...
            <div class="form-card">
                ...
                <div class="form-card-body">
                    <div>
                        ...
                        <input type="url" name="proof_url" value="{{ old('proof_url', $action->proof_url) }}"
                            placeholder="https://...">
                    </div>
                    <div style="display:flex;align-items:center;gap:.6rem">
                        <input type="checkbox" name="is_public" id="isPublic" value="1"
                            {{ old('is_public', $action->is_public) ? 'checked' : '' }}>
