...
@push('styles')
    <style>
        ...
        .queue-item[data-recent-post-item].is-active {
            border-color: #d4af37;
            background: #fffaf0;
...
@section('content')
    ...
    @endforeach
                        ...
                        @forelse($posts ?? [] as $content)
                            <div class="queue-item" data-recent-post-item
                                onclick="loadContent({{ $content->id }}, this)">
...
@push('scripts')
    <script>
        ...
        // ── Carregar histórico ────────────────────────────────────────
        async function loadContent(id, triggerEl = null) {
            try {
                ...
                if (triggerEl && triggerEl.hasAttribute('data-recent-post-item')) {
                    document.querySelectorAll('.queue-item[data-recent-post-item]').forEach(function(item) {
