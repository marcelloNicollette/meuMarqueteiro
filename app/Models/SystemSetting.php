...
class SystemSetting extends Model
{
    ...
    public static function defaults(): array
    {
        return [
            ...
            'mail_runtime_from_name' => env('MAIL_FROM_NAME', 'Meu Assistente'),
            ...
            'coverage_executive_mail_identity_name' => env('COVERAGE_EXECUTIVE_MAIL_IDENTITY_NAME', env('MAIL_FROM_NAME', 'Meu Assistente')),
